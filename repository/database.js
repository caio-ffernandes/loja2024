    ...
    const retorno = await this.#connection.execute(`
        ...
        async updateCoins(nome, valor, imagem, id) {
            const sql = `
                UPDATE coins
                SET nome_coin = ?,
                    value_coin = ?,
            ...
            const dtbs = await this.#connection.execute(sql, [nome, valor, imagem, id]);
            return dtbs[0];
        }
        ...
        async updatePersonagens(nome, genero, tipo, totalcoin,latitude,longetide,skins, id) {
            ...
            const sql = `update personagens
                ...
                start_latitude_personagem = "${latitude}",
                start_longitude_personagem = "${longetide}",
                skins_id_skin = "${skins}"
